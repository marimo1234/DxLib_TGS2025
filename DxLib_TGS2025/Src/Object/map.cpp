	...
	const Lake* lake, const Goal* goal)
{
	for (int y = 0; y < 7; y++)
	{
		for (int x = 0; x < 12; x++)
		{
			...
			case 9://山
<<<<<<< Updated upstream
				DrawRotaGraphF(MAP_TROUT_LENGTH * x + 200, MAP_TROUT_LENGTH * y + 120, 0.24, 0.0, stage.mountain_image, TRUE);
=======
				DrawRotaGraphF(MAP_TROUT_LENGTH * x + 200, MAP_TROUT_LENGTH * y + 120, 0.22, 0.0, stage.mountain_image, TRUE);
>>>>>>> Stashed changes
				break;
			}
